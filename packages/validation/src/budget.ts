...
export const createBudgetSchema = z.object({
  ...
  status: z.enum([BudgetStatus.COMPLETE_EXACT, BudgetStatus.COMPLETE_OVERPAID, BudgetStatus.COMPLETE_UNDERPAID, BudgetStatus.CANCELLED, BudgetStatus.PARTIALLY_PAID, BudgetStatus.STALLED, BudgetStatus.UNDER_PROCESS]),
